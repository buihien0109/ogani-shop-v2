...
import { useCreateTagMutation, useGetTagsQuery } from "../../app/services/tag.service";
import AppBreadCrumb from "../../components/layout/AppBreadCrumb";
import TagTable from "./TagTable";

const breadcrumb = [{ label: "Danh sách thể loại", href: "/admin/tags" }];
const TagList = () => {
    const {
        token: { colorBgContainer, borderRadiusLG },
    } = theme.useToken();

    const { data, isLoading: isFetchingTags } = useGetTagsQuery();
    const [createTag, { isLoading: isLoadingCreate }] =
