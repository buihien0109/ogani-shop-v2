...
const ModalUpdateReview = ({ show, review, handleClose, product, onSetShouldRefetch }) => {
    ...
    const onSubmit = data => {
        ...
        updateReview({ id: review.id, ...data, rating, productId: product.id })
            .unwrap()
            .then((res) => {
    ...
    return (
        ...
        >
            <Modal.Header closeButton>
                <Modal.Title>Cập nhật đánh giá sản phẩm</Modal.Title>
            </Modal.Header>
            <Modal.Body>
