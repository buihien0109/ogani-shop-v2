...
public class TransactionController {
    ...
    public ResponseEntity<?> updateTransaction(@Valid @RequestBody UpdateTransactionRequest request,
                                               @PathVariable Integer id) {
        return ResponseEntity.ok(transactionService.updateTransaction(id, request));
    }

    @PostMapping("/admin/transactions/{id}/items")
    public ResponseEntity<?> createTransactionItem(@Valid @RequestBody UpsertTransactionItemRequest request,
                                                   @PathVariable Integer id) {
    ...
    public ResponseEntity<?> updateTransactionItem(@Valid @RequestBody UpsertTransactionItemRequest request,
                                                   @PathVariable Integer id,
